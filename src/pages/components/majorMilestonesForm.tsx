      ...
      <div className="m-10 mt-24 w-[95%] pt-5">
        ...
        <div className="question">
          <span>
            ...
            just input the same date twice.
          </span>
          <br />
        ...
        <div className="question">
          <span>
            When did you come out? If this is a range, please input approximate
            start and end dates. If you have an exact date, just input the same
            date twice.
          </span>
          <br />
        ...
        <div className="question">
          <label htmlFor="hrtStart">On which day did you start HRT?</label>
          <br />
          <input
            type="date"
            id="hrtStart"
